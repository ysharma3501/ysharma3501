...
* **LavaSR**: A novel architecture for Bandwidth Extension (BWE) and speech restoration. It is designed to be the fastest and most flexible model in its class. (Accepted to **Interspeech 2026**).
...
### 🤝 Collaboration
I am looking to collaborate on **writing and publishing research papers** in the deep learning and audio DSP space. If you're working on novel speech architectures or efficient transformer scaling, would be happy to connect.
